...
Type your additional notes below:</value>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Low Support Score</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Low Tech Support Score - {{Contact_Name__c}} from {{Account_Name__c}}</value>
    </values>
    <values>
